pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~type_safety_test.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~type_safety_test.adb");
...
package body ada_main is
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_type_safety_test");
